    ...
    return (
        ...
        <div className='bg-light vh-100 d-flex justify-content-center align-items-center text-center'>
            <div>
                ...
                <p className='text-center fw-bolder m-3'>You do not have access to the requested page</p>
                <button className='btn btn-danger text-white my-2' onClick={goBack}>Go Back</button>
            </div>
        </div>
    )
}
